...
namespace LOK1game
{
    [RequireComponent(typeof(PinRapPlayerInput), typeof(Animator))]
    public class PinRapPlayerAnimation : MonoBehaviour
    {
        ...
        private PinRapPlayerInput _player;

        private void Awake()
        {
            _animator = GetComponent<Animator>();
            _player = GetComponent<PinRapPlayerInput>();

            _player.OnLeftArrowPressed += OnLeftArrowPressed;
            _player.OnUpArrowPressed += OnUpArrowPressed;
            _player.OnDownArrowPressed += OnDownArrowPressed;
            _player.OnRightArrowPressed += OnRightArrowPressed;
        }
